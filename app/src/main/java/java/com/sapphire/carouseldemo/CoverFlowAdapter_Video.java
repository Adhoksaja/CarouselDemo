...
/**
 * Created by Sapphire on 14/05/17.
 */
...
import youtubeapidemo.VideoListDemoActivity;
    ...
    private View.OnClickListener onClickListener(final int position) {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              switch (position){
                  case 0:
                      i = new Intent(activity, VideoListDemoActivity.class);
                      b = new Bundle();
                      b.putString("GMailTap", "1KhZKNZO8mQ");
                      i.putExtra("data", b);
