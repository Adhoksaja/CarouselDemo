...
import com.sapphire.carouseldemo.R;
...
public class VideoListDemoActivity extends Activity implements OnFullscreenListener {
    ...
    public static String videoIdForAutoPlay = "";
    public RecyclerView videoListRecyclerView;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            videoIdForAutoPlay = extras.getString("GMailTap");
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        public void isVideoRequested() {
            videoId = videoIdForAutoPlay;
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            if (!videoIdForAutoPlay.equalsIgnoreCase("")) {
                isVideoRequested();
            } else {
        ...
        public void setLabelVisibility(boolean visible) {
            ...
            for (View view : entryViews) {
               // view.findViewById(R.id.text).setVisibility(visible ? View.VISIBLE : View.GONE);
                view.findViewById(R.id.text).setVisibility(visible ? View.VISIBLE : View.VISIBLE);
            }
        }
